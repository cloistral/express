...
export default {
    ...
    methods: {
        ...
        drawFace() {
            ...
            this.cxt.quadraticCurveTo(this.width/3, 75, this.width/2 - 40 ,120);//创建二次贝塞尔曲线,控制点(-10,200),结束点(120,315)
            this.cxt.lineTo(this.width/2 - 40 + 40 + 40, 120);//添加一个新点，然后在画布中创建从（110，110）到（280，315）的线条
            this.cxt.quadraticCurveTo(this.width/3 * 2, 75, this.width/2 - 50 + 50 + 50, 50);
            // this.cxt.lineTo(110, 110);
            this.cxt.fill();
            this.cxt.stroke();
        },
        drawEye () {},
